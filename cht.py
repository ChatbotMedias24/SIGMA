...
"""
    ...
    if query :
        ...
        if "Donnez-moi un résumé du rapport" in query:
            summary="""Le rapport du Projet de Loi de Finances (PLF) pour l'année budgétaire 2025 fournit une analyse détaillée des Services de l'État Gérés de Manière Autonome (SEGMA), mettant en évidence la répartition et l'exécution budgétaire dans divers secteurs, tels que la santé, l'enseignement, les infrastructures économiques, et les actions sociales. Il examine les prévisions, les réalisations et les taux d'exécution des dépenses et des recettes propres de chaque domaine pour les années 2022 et 2023, soulignant un taux de recouvrement global en augmentation, notamment dans le secteur de la santé. Les données montrent une croissance significative des recettes propres et des excédents reportés, illustrant l'effort pour accroître l'autofinancement des SEGMA, malgré des écarts d'exécution entre les prévisions et les dépenses réelles d'investissement dans plusieurs domaines."""
